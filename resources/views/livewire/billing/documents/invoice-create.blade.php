<div>
    ...
    @else
                ...
                <div class="flex">
                    ...
                    <div class="w-64">
                        <x-wire-select class="mr-2" 
                            wire:model="invoice.client.tipoDoc" 
        ...
        <div class="grid gap-4 lg:grid-cols-6 mb-4">
            ...
            <div class="lg:col-span-6 grid gap-4 lg:grid-cols-2">
                ...
                <div>
                    <x-wire-input label="F. de Emisión" placeholder="Fecha de emisión" type="date"
                        ...
                        wire:model="invoice.fechaEmision" />
                </div>

                {{-- Fecha de vencimiento --}}
                <div>
                    <x-wire-input label="Vencimiento (Opcional)" type="date"
            ...
            <div class="lg:col-span-4">
                <x-wire-select 
                    ...
                    wire:model="invoice.tipoOperacion" 
                    :async-data="[
                        'api' => route('api.operations'),
                        'params' => [
                            'tipoDoc' => $invoice['tipoDoc'],
                        ],
                    ]"
        ...
        <div class="mb-4">
            <x-wire-errors only="invoice.details" />
        </div>
